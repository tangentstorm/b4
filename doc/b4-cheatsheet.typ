  ...
  [
    ...
    #block(
      ...
      #table(
        ...
        [\$1], [\^P], [\^Q], [\^R], [\^S], [\^T], [\^U], [\^V], [\^W], [\^X], [\^Y], [\^Z], text("^["), text("^/"), text("^]"), text("^^"), text("^_"),
        [\$2], [\@\@], [\@A], [\@B], [\@C], [\@D], [\@E], [\@F], [\@G], [\@H], [\@I], [\@J], [\@K], [\@L], [\@M], [\@N], [\@O],
        [\$3], [\@P], [\@Q], [\@R], [\@S], [\@T], [\@U], [\@V], [\@W], [\@X], [\@Y], [\@Z], text("@["), text("@/"), text("@]"), text("@^"), text("@_"),
        [\$4], [!\@], [!A], [!B], [!C], [!D], [!E], [!F], [!G], [!H], [!I], [!J], [!K], [!L], [!M], [!N], [!O],
        [\$5], [!P], [!Q], [!R], [!S], [!T], [!U], [!V], [!W], [!X], [!Y], [!Z], text("!["), text("!/"), text("!]"), text("!^"), text("!_"),
        [\$6], [+\@], [+A], [+B], [+C], [+D], [+E], [+F], [+G], [+H], [+I], [+J], [+K], [+L], [+M], [+N], [+O],
        [\$7], [+P], [+Q], [+R], [+S], [+T], [+U], [+V], [+W], [+X], [+Y], [+Z], text("+["), text("+/"), text("+]"), text("+^"), text("+_"),
