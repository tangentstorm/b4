...
* Compiling and Running the Code
  ...
  1. *Install free pascal 2.7.1* -- the code uses features of the svn trunk version of the compiler, so /either/:
   - *easy way:* download the [[ftp://ftp.freepascal.org/pub/fpc/snapshot/trunk/][nightly development build for your platform]]
   - *or* compile fpc manually (unnecessary, but this is what i do)
     ...
     - get the source from one of the following places :
       - ~git clone git://github.com/graemeg/lazarus.git~  (via [[http://wiki.freepascal.org/git_mirrors][fpwiki:git_mirrors]] )
         /(git is probably the best option)/
       - ~svn checkout http://svn.freepascal.org/svn/fpc/trunk fpc~
       - download the [[ftp://ftp.freepascal.org/pub/fpc/snapshot/trunk/source/fpc.zip][nightly source zipfile]]
