...
* quick lil videos showing tools i made for b4-ui.deck
- color terminal
- item list
- tabstrip
...
** TODO [0/8] make some core apps atop b4vm
...
** TODO [2/4] make a b4vm website
*** DONE register domain
*** DONE setup nginx
*** TODO find the logo i made
*** TODO convert bytecode reference to html

** TODO make videos about b4 and /using/ it

*** TODO video: design of a vm
  - instruction set
  - goals (teaching, kit, scripting apps & games)

*** TODO video: porting jprez editor
*** TODO video: colorwrite
*** TODO video: making a forth

*** TODO video: making a lisp

** TODO get tanco running in-browser for the vm

** TODO "implementing b4 in..." video series
- implementing in j
...
** TODO make some very simple demo apps
- demo: random number generator
- demo: life on the canvas
...
** TODO separate b4h and b4i tests (if possible?)
** TODO update gd version
** TODO update js version
** TODO implement the text editor
** TODO implement symbol table
** TODO implement lisp library
** TODO implement parser combinators
** TODO implement memory manager
** TODO think through "macro ops" concept
...
** TODO implement gridpad

* -- b4vm
* -- b4i (virtual machine interface)
** DONE invoke registers with ^X
** DONE b4i should store current write address ("here") in ^_
** DONE b4i should store last label address in ^^
** TODO document the assembler syntax
| prefix | meaning                |
|--------+------------------------|
| =`=      | register address       |
| =^=      | op to invoke register  |
| =.=      | invoke macro           |
| =:=      | label + chain          |
| =$=      | write address of label |

** TODO provide the built-in b3a macros
Ideally you could do this by running b4 itself.

** TODO load and save images
** TODO launch other virtual machines

* -- b3a (bootstrap assembler)
** TODO get bootstrap assembler working under test
- provides
...
** DONE find by name
** DONE execute name
** TODO load a b4a file
** TODO start with a b4x image
