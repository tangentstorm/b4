...
* TEST cscr : cscr : fill screen with spaces
#+begin_src b4a
...
* TEST .slash-0 : \0 to show and clear first line
#+begin_src b4a
  > :S 0D 'h 'e 'l 'l 'o ', 20 'w 'o 'r 'l 'd '!
  > C0 putn sp @S puts \0
  C0 hello, world!
...
** TEST b4s.ch/nc : =ch/nc= : current and next character
#+begin_src b4a
  > :K 'a 'b 'c
  > ch ?d zp
  ds: [61]
