...
#+begin_src retro
  ...
  : cell-fill!
    dup armed-neighbor-count 0 = ( cc-cf )
    .ifso   uncover ( c- )
    .else  ·hint @incl! ( c- )
    .then ;
...
** TODO minefield words  inform-neighbors needs to be replaced with counter
