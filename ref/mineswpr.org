...
#+begin_src retro
  with vt' with ng'
    ...
    : empty-draw drop                 '-   &|b               no-brackets ;
    : mine-draw  drop                 'X   &|r               no-brackets ;
    : flag-draw  drop                 '!   &|R dup &|? ` :is in-brackets ;
    : cover-draw drop                 '-   &|w               in-brackets ;
    : hint-draw  armed-neighbor-count '0 + &|B               in-brackets ;
    ...
    : (x,y)
      ...
      [ [ ·mine in? gameOver? @ and ]   [ mine-draw  ] whend
        ...
        [ ·hint  in? ]                  [ hint-draw  ] whend
        [ ·cover in? ]                  [ cover-draw ] whend
        [ drop   -1  ]                  [ empty-draw ] whend ] do
