...
*** TODO what happened to this cleanup line? 

  here [ !target ] [ !origin ] bi IMAGE-SIZE allot

*** TODO where is the "after" version of =is= for using the two return codes?
Or... what else is it for? debugger support?
...
* [0/32] Stage 3: Extend The Language
** ===================
...
#+end_src
** TODO | more stack and variable operations
...
#+end_src
** TODO ( Remap some classes for efficiency and safety ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ )
#+begin_src retro :tangle "~/vrx/image/kernel-01.rx" :padline yes :noweb tangle
here
{{
  : c: ( "- ) &.compiler reclass: ;
