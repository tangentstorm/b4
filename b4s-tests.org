...
* =node=, =newc=, =acr!=, and =done= : imperative list builder
#+name: b4s.rlis
#+begin_src b4a
  > inic
  > node @R pval \0 cscr
  (())
  > c1 cnum acr! @R pval \0 cscr
  (1 ())
  > c2 cnum acr! @R pval \0 cscr
  (1 2 ())
  > done
  > @R pval \0 cscr go00
  (1 2)
...
-acr! appends to the end of the list held in R and creates a new cell
