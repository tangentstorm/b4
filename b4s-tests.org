...
* =eval= A: (let ((k . va)) x)#+name: b4s.eval.let
#+begin_src b4a
  > :S "(let ((a . 1) (b . b)) a)"
  > C0 putn sp inic pre rval zp nil eval pval \0 cscr
  C0 1
  > :S "(let ((a . 1) (b . b)) b)"
  > C1 putn sp inic pre rval zp nil eval pval \0 cscr
  C1 b
  > :S "(let ((a . 1) (b . b)) c)"
  > C2 putn sp inic pre rval zp nil eval pval \0 cscr
  C2 ()
#+end_src
